...
DATA_LIST = [
    ...
    JsonDataFile(
        file='luca_animalia_chordata_tetrapoda_mammalia_artiodactyl',
        domain='animalia',
        taxa='Artiodactyl',
    ...
    JsonDataFile(
        file='luca_plantae_angiosperm_monocots',
        domain='plantae',
        taxa='Monocot',
    ...
    JsonDataFile(
        file='luca_plantae_angiosperm_eudicots',
        domain='plantae',
        taxa='Eudicot',
